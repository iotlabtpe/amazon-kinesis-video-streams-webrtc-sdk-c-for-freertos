...
{
    STATUS retStatus = STATUS_SUCCESS;
    CHK(signalingClientFetchSync(pAppSignaling->signalingClientHandle) == STATUS_SUCCESS, STATUS_APP_SIGNALING_FETCH);
...
{
    STATUS retStatus = STATUS_SUCCESS;
    CHK(signalingClientShutdownSync(pAppSignaling->signalingClientHandle) == STATUS_SUCCESS, STATUS_APP_SIGNALING_SHUTDOWN);
